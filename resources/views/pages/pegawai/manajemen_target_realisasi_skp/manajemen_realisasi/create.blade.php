...
@section('content-header', 'Tambah Realisasi '.$skp_target->uraian_pekerjaan_jabatan->jabatan->nama.' '. $skp_target->uraian_pekerjaan_jabatan->uraian_pekerjaan->uraian)
...
@section('content')
    ...
    <div class="container-fluid card p-4">
        <div class="col-lg-6">
            <form method="POST" action="{{ url('/pegawai/manajemen-realisasi-skp/'.$skp_target->id.'/create/store')}}" autocomplete="off" enctype="multipart/form-data" >
                @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="jml_realisasi" class="form-control" id="jml_realisasi">
                    </div>
                    <div class="mb-3">
